...
How to make extensions can be found in our [developers](#TODO) guide. For adding new features in the core, we ask to add a pull-request on GitHub.
...
When you edit something in the core we will ask you to update the documentation too. Read our [documentation](documentation.md) article to find some tips.